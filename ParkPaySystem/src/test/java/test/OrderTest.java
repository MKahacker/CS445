...
public class OrderTest {
    ...
    public void setup(){
        ...
        orderPayment = new PaymentInfo(60659, "4949494949495678", "John Doe", expiration);
    ...
    public void viewPaymentInfo(){
        assertEquals("{\"zip\":60659,\"expiration_date\":\"12/19\",\"card\":\"xxxxxxxxxxx5678\",\"name_on_card\":\"John Doe\"}",newOrder.viewPaymentInfo().toString());
    }
